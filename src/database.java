...
public class database {
    ...
    public Loggbok getData(int i) throws SQLException{
        Connection conn = DriverManager.getConnection(
                "jdbc:mysql://" + DatabaseLoginData.DBURL + ":" + DatabaseLoginData.port + "/" + DatabaseLoginData.DBname +
                        "? allowPublicKeyRetrieval=true&useSSL=false&serverTimezone=UTC",
                DatabaseLoginData.user, DatabaseLoginData.password);
        ...
        String authorSelect = "select author from log where id = " + i;
        String bodySelect = "select body from log where id = " + i;
        ...
        return new Loggbok(author, body);
    }
}
